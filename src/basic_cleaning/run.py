...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_type", 
        type = str, 
        help = "Artifact type for the cleaned dataset (e.g., 'clean_data')", 
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str, 
        help = 'Short description of the cleaning step performed',
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float, 
        help = 'Minimum nightly price; rows below this value are removed',
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = 'Maximum nightly price; rows above this value are removed',
        required = True
    )
